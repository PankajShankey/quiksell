    ...
    function getColumnHeader(group, itemCount) {
      ...
      switch (grouping) {
        case 'Status':
          return (
            <ColumnHeader 
              title={group} 
              itemCount={itemCount} 
              icon={<Icon imgSrc={statusMapping[group]}></Icon>}
            />
          );
        ...
        case 'User':
          return (
            <ColumnHeader 
              title={getUser(group)?.name} 
              itemCount={itemCount} 
              icon={<Avatar usr={getUser(group)}></Avatar>} // Assuming no icon for users
            />
          );
        ...
        case 'Priority':
          return (
            <ColumnHeader 
              ...
              itemCount={itemCount} 
              icon={<Icon imgSrc={priorityMapping[group]}></Icon>} 
            />
          );
